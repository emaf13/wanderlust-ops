...
const categoryColors: CategoryColors = new Map([
  ['Viajes', ['bg-pink-200 dark:bg-pink-900', 'bg-pink-500/80']],
  ['Naturaleza', ['bg-green-200 dark:bg-green-900', 'bg-green-500/80']],
  ['Ciudad', ['bg-yellow-200 dark:bg-yellow-900', 'bg-yellow-500/80']],
  ['Aventura', ['bg-blue-200 dark:bg-blue-900', 'bg-blue-500/80']],
  ['Playas', ['bg-purple-200 dark:bg-purple-900', 'bg-purple-500/80']],
  ['Lugares', ['bg-red-200 dark:bg-red-900', 'bg-red-500/80']],
]);
